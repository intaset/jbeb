...
<script>
  (function() {
    var cx = '016656741306535874023:3fqybuinux4';
...
<div class="j-header">
  <div class="name">
    <h1>Journal of Biomedical Engineering and Biosciences (JBEB)<!-- <br><p class="body">ISSN: 2368-5964</p> --></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-jbeb.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>Journal of Biomedical Engineering and Biosciences (JBEB)</h1>
    <div class="issn">
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "Journal of Biomedical Engineering and Biosciences (JBEB)"; 
  $message = "Thank you for signing up to receive alerts for JBEB - Journal of Biomedical Engineering and Biosciences.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to JBEB - Journal of Biomedical Engineering and Biosciences. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
